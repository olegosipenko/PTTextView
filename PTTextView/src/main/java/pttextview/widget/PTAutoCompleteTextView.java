...
/**
 * A {@link android.support.v7.widget.AppCompatAutoCompleteTextView} with native support
...
public class PTAutoCompleteTextView extends AppCompatAutoCompleteTextView {
     ...
     * @see #PTAutoCompleteTextView(Context, AttributeSet, int)
     */
     ...
     * @see #PTAutoCompleteTextView(Context, AttributeSet)
     */
