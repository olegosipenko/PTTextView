...
/**
 * A {@link android.support.v7.widget.AppCompatCheckedTextView} with native support
...
public class PTCheckedTextView extends AppCompatCheckedTextView {
     ...
     * @see #PTCheckedTextView(Context, AttributeSet, int)
     */
     ...
     * @see #PTCheckedTextView(Context, AttributeSet)
     */
