...
/**
 * A {@link android.support.v7.widget.AppCompatRadioButton} with native support
...
public class PTRadioButton extends AppCompatRadioButton {
     ...
     * @see #PTRadioButton(Context, AttributeSet, int)
     */
     ...
     * @see #PTRadioButton(Context, AttributeSet)
     */
